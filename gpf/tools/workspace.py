...
def get_workspace(table_path, root=False, **kwargs):
    """
...
def split_gdbpath(path, remove_qualifier=True):
    """
...
class WorkspaceManager(_paths.BasePathManager):
    ...
    def __init__(self, workspace, qualifier=_tu.EMPTY_STR, base=None, **kwargs):
        super(WorkspaceManager, self).__init__(workspace, base)
    ...
    def root(self):
        ...
        :rtype: gpf.common.paths.WorkspaceManager
        """
    ...
    def qualify(self, name, qualifier=None, separator=None):
        """
    ...
    def construct(self, *parts, **kwargs):
        """
