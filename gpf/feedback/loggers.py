...
import gpf.feedback.formatters as _fmt
import gpf.feedback.handlers as _hndlr
...
class Logger(object):
    ...
    .. note::               For more information about valid *log_file* values, please refer to
                            the *filename* argument for :class:`gpf.feedback.handlers.FileLogHandler`.
    """
